/** Library asset:datahedgehog_monitor/lib/lib/front_end/tool/fasta_perf_test.dart */
...
import * as lib4 from "./fasta_perf";

export var main : () => any = () => new async.Future.fromPromise(( async () : Promise<any> =>  {
    let benchIds = new core.DartList.literal('scan','kernel_gen_e2e');
