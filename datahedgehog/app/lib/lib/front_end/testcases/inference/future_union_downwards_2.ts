/** Library asset:datahedgehog_monitor/lib/lib/front_end/testcases/inference/future_union_downwards_2.dart */
...
export var g3 : () => async.Future<core.DartList<number>> = () => new async.Future.fromPromise(( async () : Promise<core.DartList<number>> =>  {
    return new MyFuture.value(new core.DartList.literal(3));
})());
...
export class properties {
    private static __$f : MyFuture<any>;
    static get f() : MyFuture<any> { 
        return this.__$f;
    }
    static set f(__$value : MyFuture<any>)  { 
        this.__$f = __$value;
    }
