/** Library asset:datahedgehog_monitor/lib/lib/front_end/testcases/inference/block_bodied_lambdas_async_all_returns_are_futures.dart */
...
export var main : () => any = () =>  {
    let f = () => new async.Future.fromPromise(( async () : Promise<any> =>  {
        if (new math.Random().nextBool()) {
            ...
            return new async.Future.value(2.0);
        }
    })());
