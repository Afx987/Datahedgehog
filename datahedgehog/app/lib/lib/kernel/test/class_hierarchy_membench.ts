/** Library asset:datahedgehog_monitor/lib/lib/kernel/test/class_hierarchy_membench.dart */
...
export var main : (args : core.DartList<string>) => any = (args : core.DartList<string>) =>  {
    ...
    if (args.contains('-v')) {
        let size : number = 0;
        for(let classHierarchy of keepAlive) {
...
export class properties {
            ...
            this.__$argParser = ((_) : any =>  {
                {
                    ...
                    addOption('count',{
                        abbr : 'c',help : 'Build N copies of the class hierarchy',defaultsTo : '300'});
                    return _;
                }
    ...
    static get usage() : string { 
        if (this.__$usage===undefined) {
            this.__$usage = `Usage: class_hierarchy_membench [options] FILE.dill\n\nOptions:\n${properties.argParser.usage}\n`;
        }
