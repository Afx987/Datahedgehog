/** Library asset:datahedgehog_monitor/lib/lib/analyzer/tool/summary/check_test.dart */
...
export var main : () => any = () =>  {
    ...
    GeneratedContent.checkAll(pkgPath,'tool/summary/generate.dart',lib5.properties.allTargets);
};
