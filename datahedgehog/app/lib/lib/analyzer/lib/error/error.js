...
exports.errorCodeByUniqueName = function (uniqueName) {
    if (utils_1.op(utils_1.Op.EQUALS, properties._uniqueNameToCodeMap, null)) {
        properties._uniqueNameToCodeMap = new core.DartHashMap();
        for (var _i = 0, _a = properties.errorCodeValues; _i < _a.length; _i++) {
            var errorCode = _a[_i];
            utils_1.op(utils_1.Op.INDEX_ASSIGN, properties._uniqueNameToCodeMap, errorCode.uniqueName, errorCode);
        }
    }
    return utils_1.op(utils_1.Op.INDEX, properties._uniqueNameToCodeMap, uniqueName);
};
var AnalysisError = /** @class */ (function () {
    function AnalysisError(source, offset, length, errorCode, arguments) {
    }
    AnalysisError_1 = AnalysisError;
    Object.defineProperty(AnalysisError, "NO_ERRORS", {
        get: function () {
            if (this.__$NO_ERRORS === undefined) {
                this.__$NO_ERRORS = new core.DartList.literal();
            }
    ...
    Object.defineProperty(AnalysisError, "FILE_COMPARATOR", {
        get: function () {
            if (this.__$FILE_COMPARATOR === undefined) {
                this.__$FILE_COMPARATOR = function (o1, o2) {
    ...
    Object.defineProperty(AnalysisError, "ERROR_CODE_COMPARATOR", {
        get: function () {
            if (this.__$ERROR_CODE_COMPARATOR === undefined) {
                this.__$ERROR_CODE_COMPARATOR = function (o1, o2) {
                    var errorCode1 = o1.errorCode;
                    var errorCode2 = o2.errorCode;
                    var errorSeverity1 = errorCode1.errorSeverity;
                    var errorSeverity2 = errorCode2.errorSeverity;
                    if (utils_1.op(utils_1.Op.EQUALS, errorSeverity1, errorSeverity2)) {
                        var errorType1 = errorCode1.type;
                        var errorType2 = errorCode2.type;
    ...
    AnalysisError.prototype.AnalysisError = function (source, offset, length, errorCode, arguments) {
        this.offset = 0;
        this.length = 0;
        ...
        var correctionTemplate = this.errorCode.correction;
        if (correctionTemplate != null) {
            this._correction = formatList(correctionTemplate, arguments);
        }
    };
    AnalysisError.prototype.forValues = function (source, offset, length, errorCode, _message, _correction) {
        this.offset = 0;
        this.length = 0;
        this.isStaticOnly = false;
        this.source = source;
    ...
    Object.defineProperty(AnalysisError.prototype, "correction", {
        get: function () {
    ...
    Object.defineProperty(AnalysisError.prototype, "hashCode", {
        get: function () {
            var hashCode = this.offset;
    ...
    Object.defineProperty(AnalysisError.prototype, "message", {
        get: function () {
    ...
    AnalysisError.prototype[_a = utils_1.OperatorMethods.EQUALS] = function (other) {
        if (core.identical(other, this)) {
            return true;
        }
        if (_common_1.is(other, AnalysisError_1)) {
    ...
    AnalysisError.prototype.toString = function () {
    ...
    AnalysisError.mergeLists = function (errorLists) {
        var errors = new core.DartHashSet();
        for (var _i = 0, errorLists_1 = errorLists; _i < errorLists_1.length; _i++) {
            var errorList = errorLists_1[_i];
            errors.addAll(errorList);
        }
        return errors.toList();
    };
    var AnalysisError_1, _a;
    __decorate([
        utils_1.defaultConstructor
    ], AnalysisError.prototype, "AnalysisError", null);
    __decorate([
        utils_1.namedConstructor
    ], AnalysisError.prototype, "forValues", null);
    __decorate([
    ...
    ], AnalysisError.prototype, "hashCode", null);
    __decorate([
        utils_1.DartMethodAnnotation({
            library: 'dart:core', type: 'override', value: {
                arguments: [], namedArguments: {}
    ...
    ], AnalysisError.prototype, _a, null);
    __decorate([
        utils_1.DartMethodAnnotation({
            library: 'dart:core', type: 'override', value: {
                arguments: [], namedArguments: {}
    ...
    ], AnalysisError.prototype, "toString", null);
    AnalysisError = AnalysisError_1 = __decorate([
        utils_1.DartClass
    ], AnalysisError);
...
var properties = /** @class */ (function () {
    ...
    Object.defineProperty(properties, "errorCodeValues", {
        get: function () {
    ...
    Object.defineProperty(properties, "_uniqueNameToCodeMap", {
        get: function () {
