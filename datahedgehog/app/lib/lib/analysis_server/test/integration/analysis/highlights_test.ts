/** Library asset:datahedgehog_monitor/lib/lib/analysis_server/test/integration/analysis/highlights_test.dart */
...
export class AnalysisHighlightsTest extends lib3.AbstractAnalysisServerIntegrationTest {
    test_highlights() {
        ...
        return this.analysisFinished.then((_ : any) =>  {
            ...
            check(HighlightRegionType.DYNAMIC_TYPE,new core.DartList.literal('dynamicType'));
            check(HighlightRegionType.FIELD,new core.DartList.literal('field'));
            check(HighlightRegionType.FIELD_STATIC,new core.DartList.literal('staticField'));
            check(HighlightRegionType.FUNCTION,new core.DartList.literal('print'));
            check(HighlightRegionType.FUNCTION_DECLARATION,new core.DartList.literal('function'));
            check(HighlightRegionType.FUNCTION_TYPE_ALIAS,new core.DartList.literal('functionType'));
            check(HighlightRegionType.GETTER_DECLARATION,new core.DartList.literal('getter'));
            ...
            check(HighlightRegionType.LOCAL_VARIABLE,new core.DartList.literal('local'));
            check(HighlightRegionType.LOCAL_VARIABLE_DECLARATION,new core.DartList.literal('local'));
            check(HighlightRegionType.METHOD,new core.DartList.literal('toList'));
            check(HighlightRegionType.METHOD_DECLARATION,new core.DartList.literal('method'));
            check(HighlightRegionType.METHOD_DECLARATION_STATIC,new core.DartList.literal('staticMethod'));
            check(HighlightRegionType.METHOD_STATIC,new core.DartList.literal('wait'));
            check(HighlightRegionType.PARAMETER,new core.DartList.literal('parameter'));
            check(HighlightRegionType.SETTER_DECLARATION,new core.DartList.literal('setter'));
            check(HighlightRegionType.TOP_LEVEL_VARIABLE,new core.DartList.literal('override','topLevelVariable'));
