/** Library asset:datahedgehog_monitor/lib/lib/analysis_server/test/analysis/notification_highlights_test2.dart */
...
export class AnalysisNotificationHighlightsTest extends lib3.AbstractAnalysisTest {
    ...
    setUp() : void {
        super.setUp();
        this.server.options.useAnalysisHighlight2 = true;
        this.createProject();
    }
    ...
    test_DYNAMIC_LOCAL_VARIABLE() : async.Future<any> { 
        return new async.Future.fromPromise(( async () =>  {
            this.addTestFile('f() {}\nmain(p) {\n  var v = f();\n  v;\n}\n');
            await this.prepareHighlights();
            this.assertHasRegion(HighlightRegionType.DYNAMIC_LOCAL_VARIABLE_DECLARATION,'v = f()');
            this.assertHasRegion(HighlightRegionType.DYNAMIC_LOCAL_VARIABLE_REFERENCE,'v;');
        } )());
    }

    test_DYNAMIC_PARAMETER() : async.Future<any> { 
        return new async.Future.fromPromise(( async () =>  {
            this.addTestFile('main(p) {\n  print(p);\n}\n');
            await this.prepareHighlights();
            this.assertHasRegion(HighlightRegionType.DYNAMIC_PARAMETER_DECLARATION,'p)');
            this.assertHasRegion(HighlightRegionType.DYNAMIC_PARAMETER_REFERENCE,'p);');
        } )());
    }

    test_DYNAMIC_VARIABLE_field() : async.Future<any> { 
        return new async.Future.fromPromise(( async () =>  {
            this.addTestFile('class A {\n  var f;\n  m() {\n    f = 1;\n  }\n}\n');
            await this.prepareHighlights();
            this.assertHasRegion(HighlightRegionType.INSTANCE_FIELD_DECLARATION,'f;');
            this.assertHasRegion(HighlightRegionType.INSTANCE_SETTER_REFERENCE,'f = 1');
        } )());
    }
    ...
    test_GETTER() : async.Future<any> { 
        return new async.Future.fromPromise(( async () =>  {
            this.addTestFile('get aaa => null;\nclass A {\n  get bbb => null;\n  static get ccc => null;\n}\nmain(A a) {\n  aaa;\n  a.bbb;\n  A.ccc;\n}\n');
            await this.prepareHighlights();
            this.assertHasRegion(HighlightRegionType.TOP_LEVEL_GETTER_DECLARATION,'aaa => null');
            this.assertHasRegion(HighlightRegionType.INSTANCE_GETTER_DECLARATION,'bbb => null');
            this.assertHasRegion(HighlightRegionType.STATIC_GETTER_DECLARATION,'ccc => null');
            this.assertHasRegion(HighlightRegionType.TOP_LEVEL_GETTER_REFERENCE,'aaa;');
            this.assertHasRegion(HighlightRegionType.INSTANCE_GETTER_REFERENCE,'bbb;');
            this.assertHasRegion(HighlightRegionType.STATIC_GETTER_REFERENCE,'ccc;');
        } )());
    }
    ...
    test_INSTANCE_FIELD() : async.Future<any> { 
        return new async.Future.fromPromise(( async () =>  {
            this.addTestFile('class A {\n  int aaa = 1;\n  int bbb = 2;\n  A([this.bbb = 3]);\n}\nmain(A a) {\n  a.aaa = 4;\n  a.bbb = 5;\n}\n');
            await this.prepareHighlights();
            this.assertHasRegion(HighlightRegionType.INSTANCE_FIELD_DECLARATION,'aaa = 1');
            this.assertHasRegion(HighlightRegionType.INSTANCE_FIELD_DECLARATION,'bbb = 2');
            this.assertHasRegion(HighlightRegionType.INSTANCE_FIELD_REFERENCE,'bbb = 3');
            this.assertHasRegion(HighlightRegionType.INSTANCE_SETTER_REFERENCE,'aaa = 4');
            this.assertHasRegion(HighlightRegionType.INSTANCE_SETTER_REFERENCE,'bbb = 5');
        } )());
    }

    test_INSTANCE_FIELD_dynamic() : async.Future<any> { 
        return new async.Future.fromPromise(( async () =>  {
            this.addTestFile('class A {\n  var f;\n  A(this.f);\n}\n');
            await this.prepareHighlights();
            this.assertHasRegion(HighlightRegionType.INSTANCE_FIELD_DECLARATION,'f;');
            this.assertHasRegion(HighlightRegionType.INSTANCE_FIELD_REFERENCE,'f);');
        } )());
    }
    ...
    test_LIBRARY_NAME_libraryDirective() : async.Future<any> { 
        return new async.Future.fromPromise(( async () =>  {
            this.addTestFile('library my.lib.name;\n');
            await this.prepareHighlights();
            this.assertHasStringRegion(HighlightRegionType.LIBRARY_NAME,'my.lib.name');
        } )());
    }

    test_LIBRARY_NAME_partOfDirective() : async.Future<any> { 
        return new async.Future.fromPromise(( async () =>  {
            this._addLibraryForTestPart();
            this.addTestFile('part of my.lib.name;\n');
            await this.prepareHighlights();
            this.assertHasStringRegion(HighlightRegionType.LIBRARY_NAME,'my.lib.name');
        } )());
    }
    ...
    test_LOCAL_FUNCTION() : async.Future<any> { 
        return new async.Future.fromPromise(( async () =>  {
            this.addTestFile('main() {\n  fff() {}\n  fff();\n  fff;\n}\n');
            await this.prepareHighlights();
            this.assertHasRegion(HighlightRegionType.LOCAL_FUNCTION_DECLARATION,'fff() {}');
            this.assertHasRegion(HighlightRegionType.LOCAL_FUNCTION_REFERENCE,'fff();');
            this.assertHasRegion(HighlightRegionType.LOCAL_FUNCTION_REFERENCE,'fff;');
        } )());
    }
    ...
    test_LOCAL_VARIABLE() : async.Future<any> { 
        return new async.Future.fromPromise(( async () =>  {
            ...
            this.assertHasRegion(HighlightRegionType.LOCAL_VARIABLE_REFERENCE,'vvv;');
            this.assertHasRegion(HighlightRegionType.LOCAL_VARIABLE_REFERENCE,'vvv = 1;');
        } )());
    }
    ...
    test_METHOD() : async.Future<any> { 
        return new async.Future.fromPromise(( async () =>  {
            this.addTestFile('class A {\n  aaa() {}\n  static bbb() {}\n}\nmain(A a) {\n  a.aaa();\n  a.aaa;\n  A.bbb();\n  A.bbb;\n}\n');
            await this.prepareHighlights();
            this.assertHasRegion(HighlightRegionType.INSTANCE_METHOD_DECLARATION,'aaa() {}');
            this.assertHasRegion(HighlightRegionType.STATIC_METHOD_DECLARATION,'bbb() {}');
            this.assertHasRegion(HighlightRegionType.INSTANCE_METHOD_REFERENCE,'aaa();');
            this.assertHasRegion(HighlightRegionType.INSTANCE_METHOD_REFERENCE,'aaa;');
            this.assertHasRegion(HighlightRegionType.STATIC_METHOD_REFERENCE,'bbb();');
            this.assertHasRegion(HighlightRegionType.STATIC_METHOD_REFERENCE,'bbb;');
        } )());
    }
    ...
    test_METHOD_bestType() : async.Future<any> { 
        return new async.Future.fromPromise(( async () =>  {
            this.addTestFile('main(p) {\n  if (p is List) {\n    p.add(null);\n  }\n}\n');
            await this.prepareHighlights();
            this.assertHasRegion(HighlightRegionType.INSTANCE_METHOD_REFERENCE,'add(null)');
        } )());
    }
    ...
    test_PARAMETER() : async.Future<any> { 
        return new async.Future.fromPromise(( async () =>  {
            ...
            await this.prepareHighlights();
            this.assertHasRegion(HighlightRegionType.PARAMETER_DECLARATION,'p) {');
            this.assertHasRegion(HighlightRegionType.PARAMETER_REFERENCE,'p;');
            this.assertHasRegion(HighlightRegionType.PARAMETER_REFERENCE,'p = 42');
        } )());
    }

    test_PARAMETER_named() : async.Future<any> { 
        return new async.Future.fromPromise(( async () =>  {
            this.addTestFile('class C {\n  final int aaa;\n  C({this.aaa, int bbb});\n}\nmain() {\n  new C(aaa: 1, bbb: 2);\n}\n');
            await this.prepareHighlights();
            this.assertHasRegion(HighlightRegionType.INSTANCE_FIELD_REFERENCE,'aaa,');
            this.assertHasRegion(HighlightRegionType.PARAMETER_DECLARATION,'bbb}');
            this.assertHasRegion(HighlightRegionType.PARAMETER_REFERENCE,'aaa: 1');
            this.assertHasRegion(HighlightRegionType.PARAMETER_REFERENCE,'bbb: 2');
        } )());
    }
    ...
    test_SETTER_DECLARATION() : async.Future<any> { 
        return new async.Future.fromPromise(( async () =>  {
            this.addTestFile('set aaa(x) {}\nclass A {\n  set bbb(x) {}\n  static set ccc(x) {}\n}\nmain(A a) {\n  aaa = 1;\n  a.bbb = 2;\n  A.ccc = 3;\n}\n');
            await this.prepareHighlights();
            this.assertHasRegion(HighlightRegionType.TOP_LEVEL_SETTER_DECLARATION,'aaa(x)');
            this.assertHasRegion(HighlightRegionType.INSTANCE_SETTER_DECLARATION,'bbb(x)');
            this.assertHasRegion(HighlightRegionType.STATIC_SETTER_DECLARATION,'ccc(x)');
            this.assertHasRegion(HighlightRegionType.TOP_LEVEL_SETTER_REFERENCE,'aaa = 1');
            this.assertHasRegion(HighlightRegionType.INSTANCE_SETTER_REFERENCE,'bbb = 2');
            this.assertHasRegion(HighlightRegionType.STATIC_SETTER_REFERENCE,'ccc = 3');
        } )());
    }
    ...
    test_STATIC_FIELD() : async.Future<any> { 
        return new async.Future.fromPromise(( async () =>  {
            this.addTestFile('class A {\n  static aaa = 1;\n  static get bbb => null;\n  static set ccc(x) {}\n}\nmain() {\n  A.aaa = 2;\n  A.bbb;\n  A.ccc = 3;\n}\n');
            await this.prepareHighlights();
            this.assertHasRegion(HighlightRegionType.STATIC_FIELD_DECLARATION,'aaa = 1');
            this.assertHasRegion(HighlightRegionType.STATIC_SETTER_REFERENCE,'aaa = 2');
            this.assertHasRegion(HighlightRegionType.STATIC_GETTER_REFERENCE,'bbb;');
            this.assertHasRegion(HighlightRegionType.STATIC_SETTER_REFERENCE,'ccc = 3');
        } )());
    }

    test_TOP_LEVEL_FUNCTION() : async.Future<any> { 
        return new async.Future.fromPromise(( async () =>  {
            this.addTestFile('fff(p) {}\nmain() {\n  fff(42);\n}\n');
            await this.prepareHighlights();
            this.assertHasRegion(HighlightRegionType.TOP_LEVEL_FUNCTION_DECLARATION,'fff(p) {}');
            this.assertHasRegion(HighlightRegionType.TOP_LEVEL_FUNCTION_REFERENCE,'fff(42)');
        } )());
    }

    test_TOP_LEVEL_VARIABLE() : async.Future<any> { 
        return new async.Future.fromPromise(( async () =>  {
            this.addTestFile('const V1 = 1;\nvar V2 = 2;\n@V1 // annotation\nmain() {\n  print(V1);\n  V2 = 3;\n}\n');
            await this.prepareHighlights();
            this.assertHasRegion(HighlightRegionType.TOP_LEVEL_VARIABLE_DECLARATION,'V1 = 1');
            this.assertHasRegion(HighlightRegionType.TOP_LEVEL_VARIABLE_DECLARATION,'V2 = 2');
            this.assertHasRegion(HighlightRegionType.TOP_LEVEL_GETTER_REFERENCE,'V1 // annotation');
            this.assertHasRegion(HighlightRegionType.TOP_LEVEL_GETTER_REFERENCE,'V1);');
            this.assertHasRegion(HighlightRegionType.TOP_LEVEL_SETTER_REFERENCE,'V2 = 3');
        } )());
    }
    ...
    test_UNRESOLVED_INSTANCE_MEMBER_REFERENCE_dynamicVarTarget() : async.Future<any> { 
        return new async.Future.fromPromise(( async () =>  {
            this.addTestFile('main(p) {\n  p.aaa;\n  p.aaa++;\n  p.aaa += 0;\n  ++p.aaa; // ++\n  p.aaa = 0;\n  p.bbb(0);\n  \'\'.length.ccc().ddd();\n}\n');
            await this.prepareHighlights();
            let type : any = HighlightRegionType.UNRESOLVED_INSTANCE_MEMBER_REFERENCE;
            this.assertHasRegion(type,'aaa');
            this.assertHasRegion(type,'aaa++');
            this.assertHasRegion(type,'aaa += 0');
            this.assertHasRegion(type,'aaa; // ++');
            this.assertHasRegion(type,'aaa =');
            this.assertHasRegion(type,'bbb(');
            this.assertHasRegion(type,'ddd()');
        } )());
    }

    test_UNRESOLVED_INSTANCE_MEMBER_REFERENCE_nonDynamicTarget() : async.Future<any> { 
        return new async.Future.fromPromise(( async () =>  {
            this.addTestFile('import \'dart:math\' as math;\nmain(String str) {\n  new Object().aaa();\n  math.bbb();\n  str.ccc();\n}\nclass A {\n  m() {\n    unresolved(1);\n    this.unresolved(2);\n    super.unresolved(3);\n  }\n}\n');
            await this.prepareHighlights();
            let type : any = HighlightRegionType.IDENTIFIER_DEFAULT;
            this.assertHasRegion(type,'aaa()');
            this.assertHasRegion(type,'bbb()');
            this.assertHasRegion(type,'ccc()');
            this.assertHasRegion(type,'unresolved(1)');
            this.assertHasRegion(type,'unresolved(2)');
            this.assertHasRegion(type,'unresolved(3)');
        } )());
    }
