...
export namespace DartUnitHighlightsComputer {
    export type Constructors = 'DartUnitHighlightsComputer';
    export type Interface = Omit<DartUnitHighlightsComputer, Constructors>;
}
@DartClass
export class DartUnitHighlightsComputer {
    _unit : any;
    ...
    @defaultConstructor
    DartUnitHighlightsComputer(_unit : any) {
    ...
    _addIdentifierRegion_dynamicType(node : any) : boolean {
        let element : any = node.staticElement;
        if (isNot(element, any)) {
            return false;
        }
...
export namespace _DartUnitHighlightsComputerVisitor {
    export type Constructors = '_DartUnitHighlightsComputerVisitor';
    export type Interface = Omit<_DartUnitHighlightsComputerVisitor, Constructors>;
}
@DartClass
export class _DartUnitHighlightsComputerVisitor extends any {
    computer : DartUnitHighlightsComputer;

    constructor(computer : DartUnitHighlightsComputer) {
    }
    @defaultConstructor
    _DartUnitHighlightsComputerVisitor(computer : DartUnitHighlightsComputer) {
